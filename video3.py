...
FULL_COURT_HEIGHT = 350
CORNER_1 = [143.0, 206.0]
CORNER_2 = [90.0, 316.0]
CORNER_3 = [743.0, 186.0]
CORNER_4 = [795.0, 281.0]
p0 = np.array([[160.0, 200.0], [235.0, 272.0], [310.0, 260.0],
               [250.0, 245.0], [300.0, 165.0]], np.float32)
p_dst = np.array([[460.0, 200.0], [535.0, 272.0], [610.0, 260.0], [
                 550.0, 245.0], [600.0, 165.0]], np.float32)
# ------------ manually chosen features
