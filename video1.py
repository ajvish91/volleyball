...
CORNER_3 = [441, 137]
CORNER_4 = [203, 287]
p0 = np.array([[120.0, 180.0], [345.0, 202.0], [295.0, 81.0],
               [250.0, 220.0], [45.0, 145.0]], np.float32)
p_dst = np.array([[120.0, 180.0], [345.0, 202.0], [295.0, 81.0], [
                 250.0, 220.0], [45.0, 145.0]], np.float32)
# ------------ manually chosen features
...
p_bg = np.array([[140.0, 210.0], [90.0, 316.0], [
                743.0, 187.0], [800.0, 282.0]], np.float32)
